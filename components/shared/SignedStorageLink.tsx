...
export function SignedStorageLink({
  ...
  if (!href) {
    return (
      <span className="text-[11px] text-muted-foreground">Preparing link…</span>
    );
  }
  ...
  return (
    <a
      ...
      className="text-[11px] font-medium text-link underline underline-offset-2 hover:text-link-hover"
    >
      {label}
    </a>
  );
